<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="address in userAddressList" :key="address.id" @click="selectAddress(address,userAddressList)">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="detailArray in detailArrayList" :key="detailArray.skuId">
          <li>
            <img :src="detailArray.imgUrl" style="width:82px;height:82px">
          </li>
          <li>
            <p>
...
export default {
  ...
  mounted() {
    this.$store.dispatch('trade/addressAndDetailArrayList')
  },
  computed: {
    ...mapState('trade', ['tradeInfo']),
    ...mapGetters('trade', ['userAddressList']),
  ...
  methods: {
    selectAddress(address, userAddressList) {
    ...
    async submitOrder() {
      ...
      const result = await this.$API.reqOrder(tradeNo, data)
      if (result.code === 200) {
